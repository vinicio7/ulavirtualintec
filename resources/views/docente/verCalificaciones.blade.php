...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   ...
   <div class="inner-block" style="margin-top: 0px;padding-top: 0px">
                    ...
                    ?>
                     <div class="portlet-grid panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{route('cursante.pruebax',$tarea->id) }}" method="get" data-toggle="validator">
                                <button type="submit" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-eye"></i> Calificar</button>
                            </form>
                        </div>
                    </div> 
